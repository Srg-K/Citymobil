...
for city in ['Санкт-Петербург','Москва', 'Воронеж']:
    ...
    regressors = ['flag_pandemic', 'flag_anomaly_down', 'flag_anomaly_up', 'flag_holiday','precipitation_volume_modif', \
    ...
    down = ['2020-08-26', '2020-12-14', '2021-07-03', '2021-07-04']
    up = ['2020-05-29', '2020-07-03', '2020-09-17', '2021-05-29']
    df['flag_anomaly_down'] = 0
    df['flag_anomaly_up'] = 0
    df.loc[df.ds.isin(down),'flag_anomaly_down'] = 1
    df.loc[df.ds.isin(up),'flag_anomaly_up'] = 1
    ...
    params= {'flag_pandemic_mode': 'additive',
             'flag_holiday_mode' : 'multiplicative',
             'precipitation_volume_modif_mode': 'multiplicative',
             'eta2rta_sh_7_mode': 'additive',
             'avg_driver_bill_sh_7_mode': 'multiplicative',
             'mean_surge_naive_sh_7_mode': 'multiplicative',
             'efficiency_sh_14_mode': 'additive',
             'avg_cancel_dist_sh_14_mode': 'multiplicative',
             'flag_anomaly_up_mode': 'multiplicative',
             'flag_anomaly_down_mode': 'multiplicative'}
    m = Prophet(
    ...
    for regressor in regressors:
        m.add_regressor(regressor, mode=params[str(regressor)+'_mode'])
    m.fit(df[:-7].fillna(0))
