...
from subsegm2segm import dict_3_segm
...
regions_to_run = regions.get_regions_to_run(type_id)
...
for i in regions_to_run:
    ...
    mysql.insert_data_frame("driver_segmentation_rfm_tmp_new", prepare_df(X))
